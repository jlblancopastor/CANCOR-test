...
```{r cc2}
load("my/working/directory/adegenet_reduced.RData") #We load cluster membership info, here I used adegenet to create clusters.
...
### Load genotype data
snps <- read.csv("TableS3.csv", header = T) # Available from the Dryad Digital Repository, https://doi.org/10.5061/dryad.0p2ngf1xk
